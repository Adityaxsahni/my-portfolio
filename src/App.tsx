...
export function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section id="contact" className="section-pad contact-section"><div className="contact-content reveal"><p className="eyebrow">05 / LET’S BUILD SOMETHING TOGETHER</p><h2>Have a problem<br />worth <em>solving?</em></h2><p>I’m always open to thoughtful conversations, ambitious products, and work that has a point of view.</p><a className="button button-primary" href="mailto:hello@adityakumar.dev">Start a conversation <Mail size={16} /></a></div><div className="contact-links reveal"><a href="mailto:adityacsc99@gmail.com"><Mail size={18} />Gmail</a><a href="https://github.com/Adityaxsahni" target="_blank" rel="noreferrer"><Github size={18} />GitHub</a><a href="https://www.linkedin.com/in/aditya-sahani-446b662a8/" target="_blank" rel="noreferrer"><Linkedin size={18} />Linkedin</a></div></section>
    </main>
