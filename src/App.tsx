...
const projects = [
  { number: '01', name: 'Signalboard', type: 'DATA PLATFORM', description: 'A calm operational dashboard for turning noisy product signals into decisions teams can act on.', outcome: 'Designed for clarity at a glance', tags: ['React', 'TypeScript', 'Charts'], href: 'https://github.com/Adityaxsahni' },
  { number: '02', name: 'Threadline', type: 'COLLABORATION TOOL', description: 'A real-time workspace that gives distributed teams a shared sense of context without the noise.', outcome: 'Fast, focused, and built to scale', tags: ['Next.js', 'Node.js', 'WebSockets'], href: 'https://github.com/Adityaxsahni' },
  { number: '03', name: 'Field Notes', type: 'OPEN SOURCE', description: 'A lightweight knowledge system for capturing technical decisions, patterns, and lessons learned.', outcome: 'Small tool, surprisingly useful', tags: ['Python', 'PostgreSQL', 'Docker'], href: 'https://github.com/Adityaxsahni' },
]
...
export function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section id="contact" className="section-pad contact-section"><div className="contact-content reveal"><p className="eyebrow">05 / LET’S BUILD SOMETHING TOGETHER</p><h2>Have a problem<br />worth <em>solving?</em></h2><p>I’m always open to thoughtful conversations, ambitious products, and work that has a point of view.</p><a className="button button-primary" href="mailto:hello@adityakumar.dev">Start a conversation <Mail size={16} /></a></div><div className="contact-links reveal"><a href="mailto:hello@adityakumar.dev"><Mail size={18} /> adityacsc99@gmail.com</a><a href="https://github.com/Adityaxsahni" target="_blank" rel="noreferrer"><Github size={18} /> github.com/Adityaxsahni</a><a href="https://www.linkedin.com/in/aditya-sahani-446b662a8/" target="_blank" rel="noreferrer"><Linkedin size={18} /> linkedin.com/in/aditya-sahani-446b662a8</a></div></section>
    </main>
